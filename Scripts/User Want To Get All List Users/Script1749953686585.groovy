...
def response = WS.sendRequest(findTestObject('Get Method/Get List Users'))
...
if ((response.getResponseBodyContent() != null)) {
	KeywordUtil.markPassed('Response Body Memiliki Value')
}else {
	KeywordUtil.markFailed('Response Body Kosong')
}

if ((json.page == 2)) {
	KeywordUtil.markPassed('Page Sudah Sesuai')
}else {
	KeywordUtil.markFailed('Page Tidak Sesuai')
}


if ((json.data[0].first_name == 'Michael')) {
